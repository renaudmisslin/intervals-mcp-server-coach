...
# Check both Windows Store install and classic web installer paths
$found = Get-ChildItem "$env:LOCALAPPDATA\Packages" -Filter "claude.exe" -Recurse -ErrorAction SilentlyContinue |
         Where-Object { $_.FullName -match "Claude_" } | Select-Object -First 1
if (-not $found) {
